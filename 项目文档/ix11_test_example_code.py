...
sys.path.append("./pdu-python-api-040000-47880")
import raritan
from raritan import rpc
from raritan.rpc import Agent, pdumodel, test, usb
...
def createAgent(ip, user, pw):
    return Agent("https", ip, user, pw, disable_certificate_verification=false)
